...
# Language dictionary
T = {
    "title": {"TR": "TariffEQ – Akıllı Sigorta Prim Hesaplama Uygulaması", "EN": "TariffEQ – Smart Insurance Premium Calculator"},
...
st.image("https://i.ibb.co/PzWSdnQb/Logo.png", caption=tr("title"))
